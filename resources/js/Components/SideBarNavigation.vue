<template>
    <div class="flex flex-col justify-between h-full px-3 py-4 overflow-y-auto rounded-lg mb-2 bg-slate-800">
        <div>
            <ul class="space-y-2 font-medium">
                <div class="flex flex-col items-center pb-5 pt-5">
                    <img class="w-48 h-48 mb-3 rounded-full shadow-lg border-2 border-gray-300"
                        src="images/avatars/profile_pic.jpeg" alt="Portfolio image" />
                    <h5 class="mb-1 text-xl font-medium text-gray-200 ">Tristan Vegas</h5>
                    <span class="text-sm text-gray-500 dark:text-gray-600">Web Developer</span>
                </div>
            </ul>
            <ul class="list-disc text-white pt-4 space-y-2 font-medium border-t border-gray-200">
                <li class="ms-5">
                    <span class="text-gray-500 transition duration-75 rounded-lg group">"Crafting Innovative Web
                        Solutions"</span>
                </li>
                <li class="ms-5">
                    <span class="text-gray-500 transition duration-75 rounded-lg group">"Bridging Design and
                        Technology with Passion"</span>

                </li>
                <li class="ms-5">
                    <span class="text-gray-500 transition duration-75 rounded-lg group">"Empowering Businesses
                        Through Modern Web Development"</span>
                </li>
            </ul>

            <ul class="pt-4 mt-4h mt-4 space-y-2 font-medium border-t border-gray-200 ">
                <li>
                    <a href="#"
